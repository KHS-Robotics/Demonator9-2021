...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    Button intaking = new Button(() -> (switchbox.intake() && !switchbox.shoot()));
    intaking.whileHeld(() -> {
  ...
  public Pose2d getStartingPose(int id) {
    ...
    switch (id) {
      case 0: 
        startPose = new Pose2d(9, 2.286, Rotation2d.fromDegrees(0));
      break;
      ...
      case 6:
        startPose = new Pose2d(1, 1.024, Rotation2d.fromDegrees(0));
      break;
